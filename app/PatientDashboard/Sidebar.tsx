...
const Sidebar: React.FC<SidebarProps> = ({ onOptionClick }) => {
        ...
        const sideItems = [
          { id: 1, text: "Booking", icon: faStethoscope },
          { id: 2, text: "Appointments", icon: faUserNurse},
          { id: 3, text: "Scans", icon: faMicroscope },
          { id: 4, text: "Requests", icon: faPaperPlane },
          { id: 5, text: "Surgeries", icon: faUserNurse}
        ];
